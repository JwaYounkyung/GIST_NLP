...
from sub_layers import Encoder, Decoder
...
enc = Encoder(input_dim=num_token, 
              hid_dim=args.hidden_size, 
              n_layers=args.num_enc_layers, 
              n_heads=args.n_head, 
              pf_dim=args.model_dim,
              dropout=args.d_prob, 
              device=device,
              max_length=args.max_len)

dec = Decoder(output_dim=num_token, 
              hid_dim=args.hidden_size, 
              n_layers=args.num_enc_layers, 
              n_heads=args.n_head, 
              pf_dim=args.model_dim,
...
model = Transformer(enc, dec, pad_idx, pad_idx, device)
model.init_weights()
