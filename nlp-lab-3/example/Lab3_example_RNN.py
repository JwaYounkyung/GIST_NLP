# RNN Classification with Glove
# https://www.kaggle.com/code/kuldeep7688/simple-rnn-using-glove-embeddings-in-pytorch/notebook
...
main_df = pd.read_csv("nlp-lab-3/example/data/train.csv")
print(main_df.shape)
...
train.to_csv("nlp-lab-3/example/data/torchtext_data/train.csv", index=False)
test.to_csv("nlp-lab-3/example/data/torchtext_data/test.csv", index=False)
valid.to_csv("nlp-lab-3/example/data/torchtext_data/valid.csv", index=False)
...
LABEL = legacy.data.LabelField(dtype=torch.long, sequential=False)

device = torch.device('cuda' if torch.cuda.is_available() else 'cpu')

# loading train, test and validation data 
train_data, valid_data, test_data = legacy.data.TabularDataset.splits(
    path="nlp-lab-3/example/data/torchtext_data/", train="train.csv", 
...
TEXT.build_vocab(train_data, vectors=torchtext.vocab.Vectors("nlp-lab-3/example/data/embeddings/glove.840B.300d/glove.840B.300d.txt"), 
...
test = pd.read_csv("nlp-lab-3/example/data/torchtext_data/test.csv")
